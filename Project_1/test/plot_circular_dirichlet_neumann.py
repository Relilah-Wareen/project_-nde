...
# 定义文件名列表
file_names = [
    'result_Circular_Dirichlet_Neumann_N8.csv',
    'result_Circular_Dirichlet_Neumann_N16.csv',
    'result_Circular_Dirichlet_Neumann_N32.csv',
    'result_Circular_Dirichlet_Neumann_N64.csv'
]
