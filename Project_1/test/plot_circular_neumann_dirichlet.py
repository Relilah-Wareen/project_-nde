...
# 定义文件名列表
file_names = [
    'result_Circular_Neumann_Dirichlet_N8.csv',
    'result_Circular_Neumann_Dirichlet_N16.csv',
    'result_Circular_Neumann_Dirichlet_N32.csv',
    'result_Circular_Neumann_Dirichlet_N64.csv'
]
